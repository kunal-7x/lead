...
const (
	...
	BillingServiceName = "evs.v1.BillingService"
)
...
const (
	...
	BillingServiceGetUsageProcedure = "/evs.v1.BillingService/GetUsage"
	// BillingServiceListInvoicesProcedure is the fully-qualified name of the BillingService's
	// ListInvoices RPC.
	BillingServiceListInvoicesProcedure = "/evs.v1.BillingService/ListInvoices"
	// BillingServiceRecordUsageProcedure is the fully-qualified name of the BillingService's
	// RecordUsage RPC.
	BillingServiceRecordUsageProcedure = "/evs.v1.BillingService/RecordUsage"
)

// BillingServiceClient is a client for the evs.v1.BillingService service.
...
// NewBillingServiceClient constructs a client for the evs.v1.BillingService service. By default, it
...
func NewBillingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) BillingServiceClient {
	...
	billingServiceMethods := v1.File_evs_v1_billing_proto.Services().ByName("BillingService").Methods()
...
// GetUsage calls evs.v1.BillingService.GetUsage.
...
// ListInvoices calls evs.v1.BillingService.ListInvoices.
...
// RecordUsage calls evs.v1.BillingService.RecordUsage.
...
// BillingServiceHandler is an implementation of the evs.v1.BillingService service.
...
func NewBillingServiceHandler(svc BillingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/evs.v1.BillingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedBillingServiceHandler) GetUsage(context.Context, *connect.Request[v1.GetUsageRequest]) (*connect.Response[v1.GetUsageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("evs.v1.BillingService.GetUsage is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) ListInvoices(context.Context, *connect.Request[v1.ListInvoicesRequest]) (*connect.Response[v1.ListInvoicesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("evs.v1.BillingService.ListInvoices is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) RecordUsage(context.Context, *connect.Request[v1.RecordUsageRequest]) (*connect.Response[v1.RecordUsageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("evs.v1.BillingService.RecordUsage is not implemented"))
}
